...
[A] HALTS
    ...
    observed by this probe (lagged, see below):       3
    ...
    upstream kept commanding motion:                24
    furthest the robot moved while blocked:      0.180 m

      #   clearance   speed    d_safe   held s   latency ms   recov
      1       0.645   0.600     0.975     0.50          8.0      0
      2       0.949   0.600     0.975     0.40          8.0      0
      3       0.934   0.582     0.936     0.30          7.0      0
------------------------------------------------------------------------------
[B] SENSOR STAMP -> ZERO COMMAND PUBLISHED
    blocking decisions:                 12
    mean:                                         7.42 ms
    p95:                                          8.00 ms
    max:                              9.00 ms
    in-node compute, mean / p95 / max:        92.9 / 173.2 / 922.6 us
