...
[A] PER ROBOT
      ...
      amr1         SUCCEEDED       18.8     10.50    10.44      0.062         0
      amr2         SUCCEEDED       11.3     10.50    10.46      0.042         0
...
[B] FLEET SEPARATION
    ...
    at t (s):                                    29.6
    median separation (m):                      3.471

    Distance between FOOTPRINT ORIGINS, so it is a clearance measure and
    not a collision check. The two routes are deconflicted by design;
    the forced conflict, mutual local deviation and the yield protocol
    are Phases 6 and 7.
------------------------------------------------------------------------------
[C] GLOBAL COSTMAP AND THE RAMP FILTER

      robot        frame        size        known    free   costed   min cost
      amr1         fleet_map    680x400     272000  248036    23964          0
      amr2         fleet_map    680x400     272000  249230    22770          0
