...
lidar height:         0.350 m above ground
...
[CONTROL] box with ordinary collision geometry - MUST be detected
  ...
  absolute closest over run:              3.48 m
...
[SUBJECT] Gazebo <actor> sweeping the corridor ahead
  ...
  scans with a return in corridor:        91.7 %
  median per-scan closest return:         2.65 m
  5th percentile:                         2.41 m
  95th percentile:                        3.14 m
  absolute closest over run:              2.33 m
  actor centre-line distance:             2.57 m
  costmap frames analysed:                  78
  peak costmap cost on actor path:         254  (LETHAL)
  costmap frames marking it lethal:      100.0 %
------------------------------------------------------------------------------
[WITNESS] camera watching the actor's path
  frames received:                         300
  mean frame-to-frame change:           1.4731 / 255
